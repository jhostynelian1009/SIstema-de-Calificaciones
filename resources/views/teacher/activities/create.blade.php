...
@section('title', 'Nueva Actividad Evaluativa - Parcial ' . $partial->number)
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <h1 class="h3 fw-bold mb-0">Registrar Nueva Actividad Evaluativa</h1>
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header bg-white py-3 border-0">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-title fw-bold mb-0 text-primary">Formulario de Registro</h5>
            ...
            <div class="card-body p-4">
                <form action="{{ route('teacher.assignments.partials.activities.store', [$assignment, $partial]) }}" method="POST">
                    @csrf

                    @include('teacher.activities._form')
